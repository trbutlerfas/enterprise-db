	...
	componentDidMount() {
		...
		.then(response => {
			this.setState({
				...
				bucketTrucks: response.data.bucketTrucks,
				ladderTrucks: response.data.ladderTrucks,
				cranes: response.data.cranes,
				...
				<div className="row justify-content-md-center">
					<div className="col-lg-8">
						<form onSubmit={this.onSubmit}>
							...
							<div className="form-group">
								<input type="submit" value="Update Vendor" className="btn btn-primary btn-block btn-lg" />
							</div>
						</form>
					</div>
				</div>
